...
class AIOrchestrator:
    ...
    def __init__(self):
        ...
        # Initialize agents (only GPT and Claude now)
        ...
        # Agent mapping for workflow engine (Gemini removed)
        self.agent_map = {
            "gpt": self.gpt_agent,
            "claude": self.claude_agent
        }
        
        self.logger.info("AI Orchestrator initialized successfully with GPT-Claude collaborative workflow")
